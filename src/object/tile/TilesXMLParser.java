...
public class TilesXMLParser extends DefaultHandler implements TilesXMLConstants {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes)
		...
		if (localName.equals(TAG_TILE)) {
			ResourcesManager.tilePassability.put(
					SAXUtils.getAttributeOrThrow(attributes, TAG_TILE_ATTRIBUTE_NAME),
					SAXUtils.getBooleanAttributeOrThrow(attributes, TAG_TILE_ATTRIBUTE_PASSABLE));
		} else if (!localName.equals(TAG_TILES)) { throw new SAXException(
				"Unexpected start tag: '" + localName + "'."); }
	}
}
